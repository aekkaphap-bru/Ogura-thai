...
namespace OCTWEB_NET45.Controllers.Leave
{
    ...
    public class LeaveController : Controller
    {
        ...
        //
        // GET: /Leave/LeaveList
        [CustomAuthorize(69)]//Leave Setup
        public ActionResult LeaveList(SearchLeave model)
        {
            try
            {
                ...
                if (Session["USE_Id"] != null)
                {
                    ...
                    //Set leave setup all(63)
                    int rights_63 = db.UserRights.Where(x => x.USE_Id == use_id && x.RIH_Id == 63).Count();

                    model.rights_62 = rights_62 > 0 ? true : false;
                    model.rights_63 = rights_63 > 0 ? true : false;
                }
        ...
        public ActionResult Create(FormCollection form, LeaveModel model)
        {
            try
            {
                ...
                if(ModelState.IsValid)
                {
                    ...
                    return RedirectToAction("LeaveList", new SearchLeave { emp_id = model.emp_id, Page = 1, 
                            start_date=leave_start_date, end_date=leave_end_date});
