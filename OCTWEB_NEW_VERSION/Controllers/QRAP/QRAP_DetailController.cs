...
{
    [Authorize]
    public class QRAP_DetailController : Controller
    {
        ...
        //
        // GET: /QRAP_Detail/List
        [CustomAuthorize(3)]//QRAP Detail
        public ActionResult List(ApproveListModel model)
        {
            ...
            {
                ViewBag.errorMessage = String.Format("Error: Get //QRAP_Detail/List {0}", ex.ToString());
                return View("Error");
            } 
        }

        //
        // POST: /QRAP_Detail/List
        [HttpPost]
        [CustomAuthorize(3)]//QRAP Detail
        public ActionResult List(FormCollection form, ApproveListModel model)
        {
            ...
            {
                ViewBag.errorMessage = String.Format("Error: Post //QRAP_Detail/List {0}", ex.ToString());
                return View("Error");
            }
        }

        //
        //GET: /QRAP_Detail/Solutions
        [CustomAuthorize(3)]//QRAP Detail
        public ActionResult Solutions(int id)
        {
            ...
            {
                ViewBag.errorMessage = String.Format("Error: Get /QRAP_Detail/Solutions {0}", ex.ToString());
                return View("Error");
            }
        }

        //
        //GET: /QRAP_Detail/Create
        [CustomAuthorize(3)]//QRAP Detail
        public ActionResult Create(int id)
        {
            ...
            {
                ViewBag.errorMessage = String.Format("Error: Get /QRAP_Detail/Create {0}", ex.ToString());
                return View("Error");
            }
        }
